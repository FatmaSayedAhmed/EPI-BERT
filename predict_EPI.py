...
def main(en_file, pr_file, out_file="result.txt"):
    tf.logging.set_verbosity(tf.logging.INFO)
    batch_size = 32
    use_tpu = False
    seq_length = 128
    vocab_file = "./vocab/vocab_1kmer.txt"
    init_checkpoint = "./model/Classifier_model_128_All/model_EPI_General_100.ckpt"
    ...
    samples_num = fasta2record(en_file, pr_file, "predict.tf_record", vocab_file)
...
if __name__ == '__main__':
    main(en_file=sys.argv[1], pr_file =sys.argv[2], out_file=sys.argv[3])
